...
const About=()=>{
  ...
  return (
    ...
    <div className="about flex justify-center w-screen shrink h-[30rem] ">


      <div className=" w-[50%]   h-[100%] pr-20 mt-16">
...
One organ donor can become a beacon of hope, saving up to 8 lives with vital organs and transforming up to 75 more through tissue donations like corneas and skin. It’s not just a donation; it’s a legacy of life, vision, and healing—proof that even in passing, we can shine a light on someone’s tomorrow.</p>
          ...
          <div className="mt-8">
          <NavLink to="register"  className= {(isActive)=> `about-link  px-4 py-2 rounded-3xl outline-none border-2 bg-red-700 hover:bg-red-800  text-lg font-semibold` }  >Register</NavLink>
          </div>
      </div>
